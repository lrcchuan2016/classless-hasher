...
namespace Classless.Hasher.Tests {
	...
	public class ParallelHashTests {
		...
		public void DefaultConstructorTest() {
			ParallelHash hasher = new ParallelHash();
			Assert.AreEqual(0, hasher.HashSize);
		}
		...
		static public object[] HashSizeTests = {
			new object[] { new System.Security.Cryptography.HashAlgorithm[] { new Whirlpool(), new Tiger(TigerParameters.GetParameters(TigerStandard.Tiger192BitVersion1)) }, 704 },
			new object[] { new System.Security.Cryptography.HashAlgorithm[] { new MD5(), new Tiger(TigerParameters.GetParameters(TigerStandard.Tiger192BitVersion1)) }, 320 },
			new object[] { new System.Security.Cryptography.HashAlgorithm[] { new MD5(), new SumBsd(), new Xor8() }, 152 },
		};
		...
		public void HashSizeTest(System.Security.Cryptography.HashAlgorithm[] algorithms, int expectedSize) {
			ParallelHash hasher = new ParallelHash(algorithms);
