...
namespace Classless.Hasher.Tests {
	class TestVectorsHMAC : TestVectors {
		static public object[] Vectors = {
			...
			new object[] { new SHA256(), h("0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B"), s("Hi There"), h("198A607EB44BFBC69903A0F1CF2BBDC5BA0AA3F3D9AE3C1C7A3B1696A0B68CF7") },
			new object[] { new SHA256(), s("Jefe"), s("what do ya want for nothing?"), h("5BDCC146BF60754E6A042426089575C75A003F089D2739839DEC58B964EC3843") },
			new object[] { new SHA256(), h("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), h("DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD"), h("CDCB1220D1ECCCEA91E53ABA3092F962E549FE6CE9ED7FDC43191FBDE45C30B0") },
			new object[] { new SHA256(), h("0102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425"), h("CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD"), h("D4633C17F6FB8D744C66DEE0F8F074556EC4AF55EF07998541468EB49BD2E917") },
			new object[] { new SHA256(), h("0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C"), s("Test With Truncation"), h("7546AF01841FC09B1AB9C3749A5F1C17D4F589668A587B2700A9C97C1193CF42") },
			new object[] { new SHA256(), h("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), s("Test Using Larger Than Block-Size Key - Hash Key First"), h("6953025ED96F0C09F80A96F78E6538DBE2E7B820E3DD970E7DDD39091B32352F") },
			new object[] { new SHA256(), h("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), s("Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data"), h("6355AC22E890D0A3C8481A5CA4825BC884D3E7A1FF98A2FC2AC7D8E064C3B2E6") },
		};
	}
}
