...
namespace Classless.Hasher.Tests {
	public class TestVectorsHash : TestVectors {
		static public object[] Vectors = {
			...
			// Fletcher
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.Empty, h("00") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.A, h("77") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.ABC, h("19") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.Alphabet, h("CC") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.Alphanumeric, h("C2") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.Numeric, h("00") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.NumericRepeated, h("00") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.Message, h("93") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.QuickFox, h("E7") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER8)), Battery.MillionAs, h("AA") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.Empty, h("0000") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.A, h("6161") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.ABC, h("4C27") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.Alphabet, h("FC2A") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.Alphanumeric, h("0C20") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.Numeric, h("2D0F") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.NumericRepeated, h("E178") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.Message, h("908A") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.QuickFox, h("FEE8") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER16)), Battery.MillionAs, h("7328") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.Empty, h("00000000") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.A, h("00610061") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.ABC, h("024A0126") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.Alphabet, h("906C0B1F") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.Alphanumeric, h("8A81150B") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.Numeric, h("0B22020D") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.NumericRepeated, h("974A1068") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.Message, h("29670585") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.QuickFox, h("5BA30FD9") },
			new object[] { new Fletcher(FletcherParameters.GetParameters(FletcherStandard.FLETCHER32)), Battery.MillionAs, h("0D662008") },
